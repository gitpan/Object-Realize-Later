...
B<use>(Object::Realize::Later OPTIONS)
...
$obj-E<gt>B<can>(METHOD)

Object::Realize::Later-E<gt>B<can>(METHOD)
...
Object::Realize::Later-E<gt>B<isa>(CLASS)
...
Object::Realize::Later-E<gt>B<import>(OPTIONS)
...
Object::Realize::Later-E<gt>B<realizationOf>(OBJECT [,REALIZED])
...
Object::Realize::Later-E<gt>B<realize>(OPTIONS)
...
This module is part of Object-Realize-Later distribution version 0.17,
built on June 08, 2007. Website: F<http://perl.overmeer.net/orl/>

=head1 LICENSE

Copyrights 2001-2004,2007 by Mark Overmeer <perl@overmeer.net>. For other contributors see Changes.
